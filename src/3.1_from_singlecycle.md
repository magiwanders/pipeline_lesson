...
This part of the lesson deals with re-arranging the components of the single cycle processor, and all the modifications to the existing signals that we have to make in order to maintain the same exact functionality and avoid runtime execution errors.
