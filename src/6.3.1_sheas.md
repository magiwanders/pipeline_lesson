...
S.H.E.A.S. is a logic ports simulator also available [standalone](https://sheas.magiwanders.com). It will however be mostly embedded in the lesson pages. Note that if the current version of S.H.E.A.S. is higher than the one shown in the tutorial and you don't understand something, you will find below the script updated to the most recent version.
